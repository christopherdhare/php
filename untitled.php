...
$featurearray = array("Gender" => array("Male","Female"),"Occupation" => array("Attorney","Business owner","Doctor","Military veteran","College professor","Member of Congress"),"Race" => array("White","Black","Hispanic","Asian-American"),"Party" => array("Democrat","Independent","Republican"),"Position on abortion" => array("Abortion should be legal in all cases, and taxpayer funds should help pay for abortions for women who have difficulty affording them.","Abortion should be legal during the first six months of pregnancy, but taxpayer funds should not be used to pay for abortions.","Abortion should be legal during the first three months of pregnancy, but taxpayer funds should not be used to pay for abortions.","Abortion should be illegal except in cases of rape, incest, and when the life of the mother is in danger.","Abortion should be illegal in all cases, including in cases of rape and incest. "),"Position on spending" => array("The federal government should greatly increase spending on programs to assist the poor, even if it means greatly increasing the national debt.","The federal government should somewhat increase spending on programs to assist the poor, even if it means somewhat increasing the national debt.","The federal government should maintain current levels of spending on programs to assist the poor, keeping the national debt around current levels.","The federal government should somewhat decrease spending on programs to assist the poor in order to somewhat reduce the national debt.","The federal government should greatly decrease spending on programs to assist the poor in order to greatly reduce the national debt."),"Position on taxes" => array("The federal government should greatly increase taxes on corporations and the wealthy in order to address income inequality, even if it hurts economic growth.","The federal government should somewhat increase taxes on corporations and the wealthy in order to address income inequality, even if it hurts economic growth.","The federal government should maintain current tax rates on corporations and the wealthy in order to keep economic growth and income inequality from getting worse.","The federal government should somewhat decrease taxes on corporations and the wealthy in order to improve economic growth, even if it worsens income inequality.","The federal government should greatly decrease taxes on corporations and the wealthy in order to improve economic growth, even if it worsens income inequality."));

$restrictionarray = array(array(array("Party","Republican"),array("Position on abortion","Abortion should be illegal in all cases, including in cases of rape and incest. ")),array(),array(),array());
...
$attrconstraintarray = array(array("Gender"));
